  ...
  return (
    <article className="landing_screen h-screen m-auto flex bg-dark-400 overflow-hidden">
      ...
      <div className="maincontainer flex flex-col justify-center phone:items-center screen:items-start phone:-ml-5 tablet:m-auto">
        <div className="herocontainer border border-lightGrayBorder bg-white phone:px-6 mx-10 screen:px-12 py-12 rounded-3xl bg-opacity-70 text-darkText relative phone:w-90v screen:w-65v desktop:w-65v twok:w-50v flex flex-col items-start">
          <div className="upperbutton bg-white border border-lightGrayBorder px-4 py-2.5 rounded-lg phone:text-caption-4 screen:leading-caption-3 desktop:text-caption-3 desktop:leading-caption-3 twok:text-caption-2 twok:leading-caption-2 desktop:font-bold twok:font-semibold">
            {"CAPX LIQUID"}
          </div>
        ...
        <div className="lowercontainer bg-white border border-lightGrayBorder screen:mt-4 desktop:mt-4 twok:mt-10 phone:px-6 screen:px-12 phone:py-2 screen:py-1 rounded-2xl bg-opacity-70 text-darkText relative phone:mt-6 phone:w-90v screen:ml-10 screen:w-52v desktop:w-50v twok:w-40v flex">
          <div className="flex phone:flex-col screen:flex-row screen:justify-between screen:items-center phone:items-start phone:text-caption-3 screen:text-caption-2 screen:leading-caption-2 desktop:text-captions-1 desktop:leading-captions-1 twok:text-paragraph-1 twok:leading-paragraph-1 w-full font-medium">
            ...
            <div>
              <div className="lowercontainer_button phone:w-32 screen:w-40 rounded-md justify-center items-center flex my-3 px-4 py-2 w-40 cursor-pointer">
                <div
                  className="button_text flex text-white screen:py-1 twok:py-0 desktop:py-1 phone:text-caption-3 screen:text-caption-3 screen:leading-caption-3 desktop:text-caption-3 desktop:leading-text-caption-3 font-bold"
                  onClick={() => {
                ...
                >
                  ...
                  <img
                    src={NextIcon}
                    alt="Next Icon"
                    className="inline-block items-center w-3 ml-2 mr-2"
                  ></img>
                </div>
              </div>
            </div>
