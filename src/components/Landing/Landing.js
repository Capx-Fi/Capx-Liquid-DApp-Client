  ...
  return (
    <article className="landing_screen h-screen m-auto flex bg-dark-400 overflow-hidden">
      ...
      <div className="maincontainer flex flex-col justify-center phone:items-center screen:items-start phone:-ml-5 tablet:m-auto">
        <div className="herocontainer phone:px-6 mx-10 screen:px-12 py-12 rounded-3xl bg-opacity-70 text-darkText relative phone:w-90v screen:w-65v desktop:w-65v twok:w-50v flex flex-col items-start">
          ...
          <div className="herocontainer_button rounded-xl screen:mt-10 desktop:mt-12 twok:mt-8 justify-center items-center flex px-5 phone:py-2 phone:mt-8 screen:py-4 z-10 cursor-pointer">
            <Link to="/vesting">
              <div className="button_text text-darkText phone:text-caption-4 screen:text-caption-2 desktop:text-caption-1 twok:text-subheading twok:leading-subheading towk:font-medium desktop:font-bold">
                {"Get Started"}
                <img
                  src={NextIcon}
                  alt="Next Icon"
        ...
        <div className="lowercontainer screen:mt-4 desktop:mt-4 twok:mt-10 phone:px-6 screen:px-12 phone:py-2 screen:py-1 rounded-2xl bg-opacity-70 text-darkText relative phone:mt-6 phone:w-90v screen:ml-10 screen:w-52v desktop:w-50v twok:w-40v flex">
