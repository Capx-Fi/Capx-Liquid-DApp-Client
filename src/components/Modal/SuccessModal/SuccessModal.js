    ...
    <article className="successmodalscreen">
      ...
      <section className="successmodalscreen_maincontainer">
        <div className="successmodalscreen_maincontainer_herocontainer">
          ...
          <p className="screen:border-div phone:text-caption-2 desktop:text-paragraph-1 screen:text-captions-1 text-caption-2 mt-5 text-center tablet:text-left tablet:w-8/12 laptop:w-10/12 desktop:w-full success_subtitle">
            You can view your vested projects in Project Owner Dashboard
          </p>
          <hr className="border-lightGrayBorder border my-10 w-4/5"></hr>
          <Level1CTA
