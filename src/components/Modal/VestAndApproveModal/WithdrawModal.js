      ...
      <Fade in={open}>
        <div className={classes.paper}>
          <div className="flex flex-col justify-center mx-auto items-center laptop:h-72 pb-8">
            ...
            />
            <div className="text-darkText text-center screen:text-subheading screen:leading-subheading leading-paragraph-2 tablet:text-caption-1 tablet:leading-heading-1 desktop:text-subheading font-semibold w-8/12 laptop:w-6/12 desktop:w-8/12">
              {withdrawModalStatus === "success"
