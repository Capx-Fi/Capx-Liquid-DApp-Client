    ...
    <div {...getRootProps()} className="px-4">
      ...
      {uploadedFile ? (
        error ? (
          <>
            <div
              className={`desktop:w-11/12 twok:w-full cursor-pointer phone:px-8 phone:py-6 px-4 desktop:py-5 screen:py-7 rounded-lg tablet:rounded-xl flex ring-2 ring-warning-color-75 flex-row bg-warning-color-25 `}
            >
              ...
              <div className="whitespace-normal tablet:text-left text-warning-color-75 desktop:text-paragraph-2 screen:text-caption-1 text-caption-2 flex ">
        ...
        <>
          <div
            className={`desktop:w-11/12 twok:w-full cursor-pointer phone:px-4 phone:py-6 tablet:px-8 px-4 desktop:py-5 screen:py-7 rounded-lg tablet:rounded-xl flex flex-row ring-1 bg-white ring-dark-25`}
          >
            <div className="flex flex-col justify-center">
              <img
                alt="upload vesting sheet"
