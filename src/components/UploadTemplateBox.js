    ...
    <div {...getRootProps()} className="px-4">
      ...
      {uploadedFile ? (
        error ? (
          <>
            <div
              className={`desktop:w-11/12 twok:w-full cursor-pointer tablet:px-8 tablet:py-6 px-4 py-5 rounded-lg tablet:rounded-xl flex ring-2 ring-warning-color-500 flex-row bg-dark-300 `}
            >
              <div className="flex flex-col justify-center">
                <img
                  alt="upload vesting sheet"
                  src={ErrorIcon}
                  className="w-6 tablet:w-6 desktop:w-8 mr-10 pt-3 inline-block my-auto"
                />
              </div>
          ...
          <>
            <div
              className={`desktop:w-11/12 twok:w-full cursor-pointer tablet:px-8 tablet:py-6 px-4 py-5 rounded-lg tablet:rounded-xl flex flex-row bg-success-color-300 bg-opacity-10 `}
            >
              <div className="flex flex-col justify-center">
                <img
                  alt="upload vesting sheet"
        ...
        <>
          <div
            className={`desktop:w-11/12 twok:w-full cursor-pointer tablet:px-8 px-4 py-5 rounded-lg tablet:rounded-xl flex flex-row ring-1 bg-dark-300 ring-success-color-300`}
          >
            <div className="flex flex-col justify-center">
              <img
                alt="upload vesting sheet"
